...
CYBER-RAJIB.cmd({
  ...
  try {
    ...
    const _0x8e739e = CYBER-RAJIB.commands.find(_0xd9686c => _0xd9686c.pattern === _0x5b0dfd) || sᴜʜᴀɪʟ_ᴍᴅ.commands.find(_0x31fef3 => _0x31fef3.alias && _0x31fef3.alias.includes(_0x5b0dfd));
    if (_0x8e739e) {
...
CYBER-RAJIB.cmd({
  ...
  try {
    ...
    let _0x1df566 = CYBER-RAJIB.commands.find(_0x3d28be => _0x3d28be.pattern === _0x4984d5) || CYBER-RAJIB.commands.find(_0x14526a => _0x14526a.alias && _0x14526a.alias.includes(_0x4984d5));
    if (!_0x1df566) {
...
sᴜʜᴀɪʟ_ᴍᴅ.cmd({
  ...
  try {
    ...
    if (!_0x4c791b) {
      return _0x32b2cc.reply("*Uhh PLease, Provide A Command to Run Cyber-Rajib*");
    }
...
smd({
  ...
  try {
    ...
    if (!isNaN(_0x56b5d3)) {
      if (_0x1eb88a.length > 0x1e && _0x1eb88a[0x1].includes('CYBER-RAJIB_FANCY_TEXT')) {
      ...
      if (_0x56c097.length > 0x0 && _0x56c097.length < 0x14) {
        ...
        for (const _0x1af79d in _0x59e793) {
          ...
          if (_0x56c097.includes(_0x37f2ac)) {
            _0x5cca14 = "┏━━━━━━━━━━━━━━━━━━━━━━━\n┃\t*CYBER-RAJIB_" + _0x1af79d.toUpperCase() + "_COMMANDS*  \n┗━━━━━━━━━━━━━━━━━━━━━━━\n\n\n";
