...
async (conn, mek, m, { from, q, reply }) => {
    try {
        ...
        const url = `https://api.mymemory.translated.net/get?q=${encodeURIComponent(textToTranslate)}&langpair=ar|${targetLang}`;
...
//____________________________TTA___________________________
cmd({
    pattern: "tta",
    desc: "download songs",
    category: "download",
